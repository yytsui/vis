...
Core.prototype._create = function (container) {
  ...
  this.dom.backgroundTopLeft    = document.createElement('div');
  ...
  this.dom.backgroundTopLeft.className    = 'vis-panel vis-background vis-topleft';
  ...
  this.dom.leftButton = document.createElement('button');
  this.dom.rightButton = document.createElement('button');
  this.dom.leftButton.innerHTML= "<";
  this.dom.rightButton.innerHTML = ">";
  this.dom.leftButton.style.position = "relative";
  this.dom.leftButton.style.zIndex = "1";
  this.dom.rightButton.style.position = "relative";
  this.dom.rightButton.style.zIndex = "1";
  //this.dom.rightButton.style.float = "right";
  //this.dom.leftButton.style.float = "right";

  this.dom.top.appendChild(this.dom.leftButton);
  this.dom.top.appendChild(this.dom.rightButton);

  var moveOn = function (percentage) {
  ...
  this.dom.leftButton.onclick = function () {
    moveOn(0.5);
  };

  this.dom.rightButton.onclick = function () {
    moveOn(-0.5);
  };


  this.dom.root.appendChild(this.dom.background);
  this.dom.root.appendChild(this.dom.backgroundTopLeft);
...
Core.prototype._redraw = function() {
  ...
  dom.backgroundTopLeft.style.left    = '0';
  dom.backgroundTopLeft.style.top     = '0';
  dom.backgroundTopLeft.style.width   =  dom.backgroundVertical.style.left;
  dom.backgroundTopLeft.style.height  =  dom.backgroundHorizontal.style.top;
  //dom.backgroundTopLeft.style.backgroundColor = "red";

  //dom.backgroundTopLeft.innerHTML = moment().format('ddd MMM D'); ; //work around, this method was actually called many times...why???

  var leftButtonMarginLeft = props.top.width -  dom.rightButton.offsetWidth - dom.leftButton.offsetWidth - 3;
  dom.leftButton.style.marginLeft =  leftButtonMarginLeft + 'px';

  //dom.rightButton.style.right = dom.top.style.width;
