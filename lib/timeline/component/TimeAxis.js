...
TimeAxis.prototype.redraw = function () {
  ...
  //foreground.style.marginTop = (-1) * props.height;
  var marginTop = (-1) * props.height;
  this.dom.foreground.style.marginTop = marginTop.toString() + "px";
  //this.dom.foreground.style.marginTop = "-26px";
  ...
  //this.body.emitter.emit("timeAxisRedraw");
...
TimeAxis.prototype._repaintMajorText = function (x, text, orientation, className) {
  ...
  //label.childNodes[0].nodeValue = text;
  label.childNodes[0].nodeValue = ''; // disable for epg
